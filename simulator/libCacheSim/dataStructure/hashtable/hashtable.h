...
#define hashtable_f_find_obj_id(hashtable, obj_id) chained_hashtable_f_find_obj_id_v2(hashtable, obj_id)
...
#define hashtable_f_insert_obj(hashtable, cache_obj) chained_hashtable_f_insert_obj_v2(hashtable, cache_obj)
#define hashtable_delete(hashtable, cache_obj) chained_hashtable_delete_v2(hashtable, cache_obj)
#define hashtable_try_delete(hashtable, cache_obj) chained_hashtable_try_delete_v2(hashtable, cache_obj)
#define hashtable_delete_obj_id(hashtable, obj_id) chained_hashtable_delete_obj_id_v2(hashtable, obj_id)
...
#define free_chained_hashtable_f(hashtable) free_chained_hashtable_f_v2(hashtable)
