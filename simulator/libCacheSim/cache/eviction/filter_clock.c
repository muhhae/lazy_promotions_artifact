// //
// //  FClock, the same as FIFO-Reinsertion or second chance, is a FIFO with
...
// static void FClock_parse_params(cache_t *cache,
//                                const char *cache_specific_params);
// static void FClock_free(cache_t *cache);
// static bool FClock_get(cache_t *cache, const request_t *req);
// static cache_obj_t *FClock_find(cache_t *cache, const request_t *req,
//                                const bool update_cache);
// static cache_obj_t *FClock_insert(cache_t *cache, const request_t *req);
// static cache_obj_t *FClock_to_evict(cache_t *cache, const request_t *req);
// static void FClock_evict(cache_t *cache, const request_t *req);
// static bool FClock_remove(cache_t *cache, const obj_id_t obj_id);
...
//  */
// cache_t *FClock_init(const common_cache_params_t ccache_params,
//                     const char *cache_specific_params) {
//   cache_t *cache =
//       cache_struct_init("FClock", ccache_params, cache_specific_params);
...
//   FClock_parse_params(cache, DEFAULT_PARAMS);
//   if (cache_specific_params != NULL) {
//     FClock_parse_params(cache, cache_specific_params);
//   }
